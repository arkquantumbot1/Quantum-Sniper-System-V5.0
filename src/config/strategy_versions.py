...
def get_version_info(strategy_type: str, version: str) -> Optional[Dict[str, Any]]:
    """获取指定策略版本信息"""
    if (
        strategy_type in STRATEGY_VERSIONS
        and version in STRATEGY_VERSIONS[strategy_type]
    ):
...
def get_available_versions(
    strategy_type: str = "quantum_neural_lattice",
...
def create_strategy_instance(
    strategy_type: str, version: str, config: Dict[str, Any] = None
):
    """创建策略实例"""
