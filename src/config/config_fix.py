...
class ConfigFixManager:
    ...
    def __init__(self, project_root: str = None):
        self.project_root = project_root or os.getenv('QUANTUM_SNIPER_ROOT', 
    ...
    def _get_fixed_config_content(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'order_executor': {
                ...
                'enabled_exchanges': ['binance', 'bybit', 'okx', 'bingx', 'bitget', 'mexc'],
    ...
    def validate_config_file(self) -> Tuple[bool, List[str]]:
        ...
        try:
            ...
            # 验证必要配置段
            required_sections = ['system', 'order_executor', 'risk_management', 'trading']
            ...
            required_order_fields = ['execution_mode', 'enabled_exchanges', 'default_exchange']
